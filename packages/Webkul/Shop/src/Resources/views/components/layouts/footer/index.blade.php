...
<footer class="mt-9 max-sm:mt-10" style="background-color: #f0e4d5;">
    ...
    <div class="flex justify-between px-[60px] py-3.5 max-md:justify-center max-sm:px-5" style="background-color: #f0e4d5;">
